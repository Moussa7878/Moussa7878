...
import kotlinx.android.synthetic.main.fragment_challange_page.view.*




class ChallengePageFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        mView = inflater.inflate(R.layout.fragment_challange_page, container, false)

        mView.iv_main_image.setOnClickListener {
            getActivityContext?.
            replaceFragment(
                ChallengesFragment(),
                ChallengesFragment.javaClass.simpleName,true,false)
        }
