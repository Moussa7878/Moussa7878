...
import com.fictivestudios.tafcha.fragments.friends_trainers.FriendsFragment
...
import kotlinx.android.synthetic.main.fragment_leaderboard_page.view.*
 ...
 */
class LeaderboardPageFragment : BaseFragment() {
    ...
    override fun onCreateView(
        ...
        mView =  inflater.inflate(R.layout.fragment_leaderboard_page, container, false)

        mView.iv_main_image.setOnClickListener {

            getActivityContext?.
            replaceFragment(LeaderboardFragment(),
                FriendsFragment().javaClass.simpleName,
                true,false)
