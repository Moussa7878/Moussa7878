package com.fictivestudios.tafcha.streaming.tests.ConferenceStreamManagerTest;

import android.os.Handler;
import android.os.Looper;

import com.fictivestudios.tafcha.streaming.tests.ConferenceTest.ConferenceTest;
...
public class ConferenceStreamManagerTest extends ConferenceTest {
	...
	private void delayRetryRequest (final String streamName, final String context, final String action, final StreamURLDelegate starter) {
	...
	private void requestServer(final String streamName, final String context, final String action, final StreamURLDelegate starter){
...
//						throw new IOException(statusLine.getReasonPhrase());
	...
	public void publish() {
		...
		requestServer(pubName, context, "broadcast",  new StreamURLDelegate() {
			@Override
	...
	public void Subscribe(final String toName) {
		final String context = TestContent.GetPropertyString("context") + "/" + roomName;
		requestServer(toName, context, "subscribe",  new StreamURLDelegate() {
			@Override
			public void passURL(String url) {
				config.setHost(url);
				config.setContextName(context);
