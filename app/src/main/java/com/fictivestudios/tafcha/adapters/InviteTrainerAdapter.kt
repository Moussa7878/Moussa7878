...
class InviteTrainerAdapter (context: Context, private val mlist: ArrayList<AlltrainersItem>?) :
    RecyclerView.Adapter<InviteTrainerAdapter.ViewHolder>() {
